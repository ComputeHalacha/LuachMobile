...
export default class FindKavuahScreen extends React.Component {
    ...
    addKavuah(pk) {
        const appData = this.appData,
            ...
            kavuah =
                kList.find(k => k.isMatchingKavuah(pk.kavuah)) || pk.kavuah;
        ...
        DataUtils.KavuahToDatabase(kavuah).then(() => {
            ...
            popUpMessage(
                `The Kavuah ${kavuah.toString()} has been added to the list`
            );
    ...
    render() {
        const pk =
            this.state.possibleKavuahList.length > 0 &&
                            ...
                            <View style={GeneralStyles.center}>
                                ...
                                <View
                                    ...
                                    <Text
                                        ...
                                        Entries used for this calculatation:
                                    </Text>
                                    {pk.entries.map((e, i) => (
                                        <Text
                                            key={i}
                                ...
                                <View style={{ marginTop: 10, padding: 10 }}>
                                    ...
                                    <Text>
                                        ...
                                        not yet sure whether or not to add this
                                        Kavuah. The next time the list of
                                        Entries is checked for possible Kavuahs,
                                        this Kavuah will be shown again as a
                                        possible Kavuah.
                                    </Text>
                                    <Text
                                        style={{
