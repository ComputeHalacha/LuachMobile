...
const exportPath = fs.DocumentDirectoryPath;
        ...
        switch (this.state.dataSet) {
            case 'Entries':
                ...
                for (let entry of this.appData.EntryList.list) {
                    ...
                    html += `<tr>
                                 ...
                                 <td>${entry.date.toString()}<br />${Utils.toStringDate(
                        entry.date.getDate(),
                        true,
                        true
                    )}</td>
            ...
            case 'Flagged Dates':
                ...
                for (let probOnah of this.appData.ProblemOnahs) {
                    ...
                    html += `<tr>
                                <td><b>${counter.toString()}</b></td>
                                <td>${probOnah.jdate.toString()}<br />${Utils.toStringDate(
                        probOnah.jdate.getDate(),
                        true,
                        true
                    )}</td>
                                <td>${
                    ...
                    <ScrollView style={{ flex: 1 }}>
                        <View style={GeneralStyles.formRow}>
                            ...
                            <Select
                                ...
                                <Option value="Kavuahs">Kavuahs</Option>
                                <Option value="Settings">Settings</Option>
                                <Option value="Flagged Dates">
                                    Flagged Dates
                                </Option>
                                <Option value={dateStr}>{dateStr}</Option>
                                <Option value={jMonthStr}>{jMonthStr}</Option>
                                <Option value={sMonthStr}>{sMonthStr}</Option>
                            </Select>
                        </View>
                        <View
                            style={{
                            ...
                            <Text>
                                When you press on "Export to Email" below, the
                                email app will open in "compose" mode, with an
                                email containing {dataDesc}.{'\n\n'}
                                In addition, a spreadsheet with {dataDesc} will
                                be attached to the email.
                                {!this.state.dataSet.startsWith('Zmanim') && (
                                    <Text>
                                        {'\n\n'}
                                        It is advisable to send this email to
