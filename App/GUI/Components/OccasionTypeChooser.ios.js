    ...
    getSelectedTypeDesc(occasionType) {
        ...
        switch (occasionType) {
            ...
            case UserOccasionTypes.HebrewDateRecurringYearly:
                return (
                    'Annual - every ' +
                    `${Utils.jMonthsEng[jdate.Month]} ${Utils.toSuffixed(
                        jdate.Day
                    )}`
                );
            case UserOccasionTypes.SecularDateRecurringYearly:
                return (
                    'Annual - every ' +
                    `${Utils.sMonthsEng[sdate.getMonth()]} ${Utils.toSuffixed(
                        sdate.getDate()
                    )}`
                );
        ...
        return (
            <View style={GeneralStyles.formRow}>
                ...
                <Select
                    ...
                    defaultText={
                        this.getSelectedTypeDesc(this.props.occasionType) ||
                        'Select event type'
                    }
                    ...
                    <Option value={UserOccasionTypes.HebrewDateRecurringYearly}>
                        {this.getSelectedTypeDesc(
                            UserOccasionTypes.HebrewDateRecurringYearly
                        )}
                    </Option>
                    <Option
                    ...
                    <Option
                        ...
                        {this.getSelectedTypeDesc(
                            UserOccasionTypes.HebrewDateRecurringMonthly
                        )}
                    </Option>
                    <Option
