            ...
            <View>
                <View style={GeneralStyles.formRow}>
                    ...
                    <Select
                        ...
                        defaultText={Kavuah.getKavuahTypeText(
                            this.props.kavuahType
                        )}
                        ...
                        <Option value={KavuahTypes.Haflagah}>
                            {Kavuah.getKavuahTypeText(KavuahTypes.Haflagah)}
                        </Option>
                        <Option value={KavuahTypes.DayOfMonth}>
                            {Kavuah.getKavuahTypeText(KavuahTypes.DayOfMonth)}
                        </Option>
                        <Option value={KavuahTypes.DayOfWeek}>
                            {Kavuah.getKavuahTypeText(KavuahTypes.DayOfWeek)}
                        </Option>
                        <Option value={KavuahTypes.DilugHaflaga}>
                            {Kavuah.getKavuahTypeText(KavuahTypes.DilugHaflaga)}
                        </Option>
                        <Option value={KavuahTypes.DilugDayOfMonth}>
                            {Kavuah.getKavuahTypeText(
                                KavuahTypes.DilugDayOfMonth
                            )}
                        </Option>
                        <Option value={KavuahTypes.Sirug}>
                            {Kavuah.getKavuahTypeText(KavuahTypes.Sirug)}
                        </Option>
                        <Option value={KavuahTypes.HaflagaMaayanPasuach}>
                            {Kavuah.getKavuahTypeText(
                                KavuahTypes.HaflagaMaayanPasuach
                            )}
                        </Option>
                        <Option value={KavuahTypes.DayOfMonthMaayanPasuach}>
                            {Kavuah.getKavuahTypeText(
                                KavuahTypes.DayOfMonthMaayanPasuach
                            )}
                        </Option>
                        <Option value={KavuahTypes.HafalagaOnahs}>
                            {Kavuah.getKavuahTypeText(
                ...
                <View style={GeneralStyles.formRow}>
                    ...
                    <Select
                        ...
                        {this.props.listOfEntries.map(entry => (
                            <Option value={entry} key={entry.entryId}>
                                {entry.toString()}
                            </Option>
                        ))}
                    </Select>
                ...
                <View style={GeneralStyles.formRow}>
                    <Text style={GeneralStyles.label}>
                        {Kavuah.getNumberDefinition(this.props.kavuahType)}
                    </Text>
                    <Select
